...
public class HashMapDemo {
	...
	public static void main(String[] args) {
		...
		Map<Employees, Integer> testMap = new HashMap();
		Employees java = new Employees("Java", 1, 10000.00);
		Employees techies = new Employees("Techies", 2, 20000.00);
		testMap.put(new Employees("Java", 1, 10000.00), 1);
		testMap.put(new Employees("Techies", 2, 20000.00), 2);
		testMap.put(new Employees("Techies", 2, 20000.00), 3);
		testMap.put(new Employees("Techies", 2, 20000.00), 4);
		testMap.put(null, 5);
		testMap.put(null, 6);
